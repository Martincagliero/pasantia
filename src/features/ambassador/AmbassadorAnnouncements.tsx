            ...
            return (
              <Card key={i.id} hover className="flex flex-col">
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2 sm:mt-5">
                  ...
                  <button
                    onClick={() => setDetail(i)}
                    className="rounded-full border border-white/15 bg-white/5 px-3 py-1.5 text-xs font-medium text-white/80 transition hover:bg-white/10 hover:text-white sm:px-3.5 sm:py-2 sm:text-sm"
                  >
                    Ver detalle
                  </button>
                  {ownIds.has(i.id) && (
