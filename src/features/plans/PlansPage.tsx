...
const AMBASSADOR_PLANS = [
  ...
  },
  {
    ...
    features: ['Todo lo incluido en Gratis', 'Perfil destacado primero en Explorar', 'Tilde Pro junto al nombre', 'Verificación de cuenta', 'Reportes de alcance', 'Soporte prioritario'],
  },
];
