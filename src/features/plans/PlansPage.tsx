...
const STUDENT_PLANS = [
  ...
  },
  {
    plan: 'pro' as const,
    name: 'Estudiante Pro',
    features: ['Postulaciones ilimitadas', 'Conexiones sin límite', 'Mensajes sin conexión previa', 'Perfil destacado primero en Explorar', 'Tilde Pro junto al nombre', 'Acceso a solicitar verificación'],
  },
];
...
const COMPANY_PLANS = [
  ...
  },
  {
    plan: 'pro' as const,
    name: 'Empresa Pro',
    features: ['Publicaciones ilimitadas', 'Todos los postulados y gestión completa', 'Perfil destacado primero en Explorar', 'Tilde Pro junto al nombre', 'Acceso a solicitar verificación', 'Mensajería y estadísticas'],
  },
  {
...
const AMBASSADOR_PLANS = [
  ...
  },
  {
    ...
    features: ['Todo lo incluido en Gratis', 'Perfil destacado primero en Explorar', 'Tilde Pro junto al nombre', 'Acceso a solicitar verificación', 'Reportes de alcance', 'Soporte prioritario'],
  },
];
