-- ============================================================================
-- PasantIA — Cuenta DEMO de empresa para probar el login
-- ----------------------------------------------------------------------------
-- Crea una empresa YA CONFIRMADA (sin enviar emails) para poder ingresar.
-- Cómo usar:
...
begin
  ...
  loop
    execute format(
      ...
      'pasantia.empresa.demo@gmail.com', 'pasantia.empresa.demo@gmail.com'
    );
  end loop;
end $$;
